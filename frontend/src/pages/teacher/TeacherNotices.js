...
const TeacherNotices = () => {
    ...
    const [formData, setFormData] = useState({
        title: '',
        content: '',
        target_type: 'class', // Default to class for teachers
        target_class_id: '',
        type: 'info'
    });
    ...
    const fetchNotices = async () => {
        ...
        setLoading(true);
        try {
            // Teachers can see notices they created
            const q = query(
        ...
        <div className="notices-management">
            <div className="page-header">
                <div>
                    ...
                    <p className="page-description">Create and manage notices for your students.</p>
                </div>
